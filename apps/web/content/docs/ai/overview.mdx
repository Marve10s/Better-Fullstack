...
capability/deployment additions as structured tools. See the [MCP setup guide](/docs/ai/mcp/).

This is distinct from the generated-project `mcp` capability. The server helps an agent create Better Fullstack projects; the capability writes MCP configuration inside a generated project.
