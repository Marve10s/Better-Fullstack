...
description: Choose generated web frontends, mobile apps, and app-platform capabilities.
...
App-platform capabilities such as Tauri, PWA, WXT, and OpenTUI add shell, offline, extension, or terminal app targets around compatible stacks.
