...
| .NET      | ASP.NET Identity, Duende IdentityServer, Auth0 ASP.NET, or none.                                                     |

## Payments

Payment providers are TypeScript-first today: Polar, Stripe, Lemon Squeezy, Paddle, Dodo, Creem, Autumn, Commet, or none. Creem also ships a Better Auth plugin (server + client) when paired with Better Auth.
...
- [.NET options](/docs/reference/options/dotnet/)
