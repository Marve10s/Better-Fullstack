...
description: Elige styling, librerias de componentes, formularios, validacion, estado, animacion e i18n.
---

Las opciones de UI y experiencia dan forma al codigo frontend generado, los primitivos de diseno y los patrones de aplicacion del lado cliente.
...
## Formularios, validacion y estado

Las opciones de aplicacion frontend incluyen:
