...
| .NET      | ASP.NET Core Minimal APIs, MVC, Blazor, or none. |
...
API choices include TypeScript RPC/GraphQL options, Rust Tonic or async-graphql, Python Django
API/GraphQL options, Go gRPC, Elixir REST or Absinthe, and .NET Minimal APIs, Hot Chocolate, or gRPC.
