...
- Caching: Upstash Redis (serverless) or self-hosted Redis via ioredis in TypeScript, plus ecosystem-specific cache choices where supported.
- Search: Meilisearch, Typesense, Elasticsearch, OpenSearch, Algolia, plus ecosystem-native options — Bleve (embedded) for Go and Elasticsearch for Python.
