...
TypeScript es el ecosistema mas amplio de Better Fullstack. Usalo para apps web, APIs, workers, shells desktop, extensiones de navegador, sitios de documentacion, integraciones de servicios y la mayoria de workflows de addons.
...
- Qwik, Angular, Redwood y Fresh tienen soporte API/backend mas estrecho que la tabla completa.
- El soporte de Workers runtime depende del backend.
- Las UI libraries suelen depender de la familia de frontend y del CSS framework. Por ejemplo, shadcn/ui esta orientado a React y basado en Tailwind.
