...
Use the schema-derived [Rust options reference](/docs/reference/options/rust/) for the exhaustive
framework, data, API, CLI, library, logging, auth, realtime, and infrastructure values.
