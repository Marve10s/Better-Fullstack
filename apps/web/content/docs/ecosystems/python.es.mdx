---
title: Python
description: Scaffolds Python para APIs y servicios de IA con frameworks web, ORMs, validacion, colas, GraphQL y tooling de calidad.
---

Los proyectos Python usan `uv` y plantillas nativas de Python. Elige opciones Python para frameworks API, ORMs, validacion, librerias de IA, helpers de auth, task queues, GraphQL y tooling de calidad.
...
- `uv sync` es la ruta de instalacion cuando install esta activado.
- `pythonAi` es multi-select y esta separada de `--ai` de TypeScript.
