...
Use the schema-derived [Elixir options reference](/docs/reference/options/elixir/) for the
exhaustive Phoenix, data, auth, API, realtime, jobs, quality, and deploy values.
