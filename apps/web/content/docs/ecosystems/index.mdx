...
Better Fullstack uses one CLI for multiple ecosystems, but each ecosystem has its own scaffold surface. TypeScript focuses on fullstack web, React Native focuses on Expo mobile apps, and Rust, Python, Go, and Java focus on language-native project templates.
