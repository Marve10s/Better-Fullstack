...
Use the schema-derived [Go options reference](/docs/reference/options/go/) for the exhaustive
framework, data, API, CLI, logging, auth, testing, and infrastructure values.
