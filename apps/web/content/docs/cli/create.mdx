...
Platform and ecosystem flags answer the shape's question ahead of time, which keeps shapes usable in scripts:

```bash
# Prompts for the mobile platform
bun create better-fullstack@latest my-app --shape mobile

# Answers it up front, no prompt
bun create better-fullstack@latest my-app --shape mobile --kotlin-mobile compose-multiplatform
bun create better-fullstack@latest my-app --shape backend --ecosystem go
```
