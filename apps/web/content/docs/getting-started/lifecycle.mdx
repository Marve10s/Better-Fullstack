...
Continue with [Add and Remove Capabilities](/docs/cli/add/), [Status, Check, Update](/docs/cli/update/), or [Choosing a Stack](/docs/stack-guides/) for guidance on what to select next.
