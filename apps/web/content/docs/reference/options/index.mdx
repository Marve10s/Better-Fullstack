...
| --- | --- | --- | --- |
| [TypeScript Options](/docs/reference/options/typescript/) | TypeScript web categories: frontend, backend, runtime, data, API, auth, UI, services, tooling, examples, addons, and deploy. | 46 | 310 |
