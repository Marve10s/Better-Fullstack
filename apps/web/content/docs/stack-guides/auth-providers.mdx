...
- **Payments can require Better Auth.** For example, Polar requires Better Auth and a web frontend. Review the [Compatibility Matrix](/docs/reference/compatibility/).
