...
Open the [Mobile App pack in the Stack Builder](/new?preset=uniwind&view=command&file=), or run:
...
For the stack-level walkthrough, read [Expo Uniwind Native App](/guides/typescript/expo-uniwind-native/).
