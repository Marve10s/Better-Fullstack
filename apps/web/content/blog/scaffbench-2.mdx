...
description: "ScaffBench 2 runs four Opus versions and GPT-5.5 (two efforts) through five hard fullstack specs across TypeScript, Rust, Python, Go, and .NET via three creation paths — scoring not just 'does it build' but wired libraries, command discipline, cost, and a composite Index."
date: 2026-06-26
authors:
  - Ibrahim Elkamali
tags:
