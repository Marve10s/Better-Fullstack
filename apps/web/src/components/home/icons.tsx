  ...
  switch (pm) {
    ...
    case "pnpm":
      return (
        ...
        >
          ...
          <path d="M20.374,20.375h-8.75v-8.75h8.75Z" fill="#fff" />
          <path d="M20.374,30h-8.75V21.25h8.75Z" fill="#fff" />
          <path d="M30,30H21.251V21.25H30Z" fill="#fff" />
          <path d="M10.749,30H2V21.25h8.749Z" fill="#fff" />
        </svg>
      );
    case "bun":
      return (
    ...
    case "yarn":
      return (
        ...
        >
          <title>yarn</title>
          <path d="M12 0C5.375 0 0 5.375 0 12s5.375 12 12 12 12-5.375 12-12S18.625 0 12 0m6.082 17.478c-.353.132-.6.209-1.16.209-.939 0-1.399-.385-2.168-.952a10 10 0 0 1-.44-.327c-.47.21-.993.353-1.548.443-.627.103-1.28.103-1.772.029a5 5 0 0 1-.372-.068c-.084.155-.186.308-.325.46-.496.552-.924.654-1.453.795-.168.044-.352.093-.558.163-.54.183-.91.171-1.195.104-.39-.091-.647-.382-.773-.614a.7.7 0 0 1-.08-.353c.013-.296.16-.54.38-.727.255-.22.605-.373.907-.498l.062-.027c.485-.198.846-.383 1.086-.747.065-.1.123-.21.172-.335-.578-.91-.87-2.115-.715-3.445.17-1.489.807-2.64 1.397-3.438-.18-.6-.369-1.498-.168-2.558.138-.752.473-1.3.997-1.629a1.08 1.08 0 0 1 .956-.103c.479.165 1.683.79 2.583 2.07.603-.187 1.36-.344 2.2-.373.577-.022 1.126.027 1.637.131.298-.38.648-.737 1.065-1.025.627-.434 1.267-.613 1.504-.605a.85.85 0 0 1 .594.26c.397.39.513 1.063.528 1.757a5.1 5.1 0 0 1-.336 2.025l.018.028c.646 1.014 1.045 2.129 1.098 3.467.026.744-.058 1.37-.201 1.907a4.5 4.5 0 0 1-.847 1.57c.244.22.457.47.6.782.148.328.2.713.089 1.094-.178.616-.645 1.024-1.293 1.244" />
        </svg>
      );
