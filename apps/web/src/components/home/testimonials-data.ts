...
export const ROW_2: Testimonial[] = [
  {
    ...
    comment:
      "270+ options sounds powerful. The real question is how deep the generated code goes — if it actually handles the opinionated glue between layers, this is genuinely impressive infrastructure.",
  },
  {
    name: "Maxx",
    avatar:
