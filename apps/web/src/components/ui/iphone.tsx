...
/** Device frame adapted from Magic UI's iPhone mockup; children render inside the screen. */
export function Iphone({ children, className, style, ...props }: IphoneProps) {
  ...
  return (
    ...
    >
      ...
      >
        <g mask={hasMedia ? `url(#screenPunch-${ids})` : undefined}>
          <path
        ...
        <path
          ...
          mask={hasMedia ? `url(#screenPunch-${ids})` : undefined}
        />
        ...
        <defs>
          <mask id={`screenPunch-${ids}`} maskUnits="userSpaceOnUse">
          ...
          <clipPath id={`roundedCorners-${ids}`}>
            <rect
              x={SCREEN_X}
              y={SCREEN_Y}
              width={SCREEN_WIDTH}
