...
/** Browser frame adapted from Magic UI's Safari mockup; children render inside the viewport. */
export function Safari({
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <mask id={`safariPunch-${ids}`} maskUnits="userSpaceOnUse">
        ...
        <g clipPath={`url(#path0-${ids})`} mask={hasMedia ? `url(#safariPunch-${ids})` : undefined}>
          <path
