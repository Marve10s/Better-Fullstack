...
/* BadgeButton renders a span-based control as shipped by the source registry;
   the explicit role is intentional here, so scope-disable the prefer-tag rule
   rather than changing the rendered element. */
