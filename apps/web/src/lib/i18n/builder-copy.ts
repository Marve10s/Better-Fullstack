...
const EXACT_DESCRIPTIONS: Record<string, LocalizedMap> = {
  "End-to-end typesafe APIs": {
    ...
    "zh": "端到端类型安全 API",
    "ja": "エンドツーエンドのタイプセーフ APIs",
    "ko": "종단 간 유형 안전 APIs",
    "zh-Hant": "端對端類型安全性 APIs",
    "de": "Durchgängig typsichere APIs",
    "fr": "APIs sécurisés de bout en bout",
    "uk": "Наскрізна типозахищеність APIs",
  },
  "Typesafe APIs Made Simple": {
    "es": "APIs type-safe de forma simple",
    "zh": "简单的类型安全 API",
    "ja": "タイプセーフ API をシンプルに",
    "ko": "Typesafe APIs가 단순해졌습니다.",
    "zh-Hant": "類型安全性 APIs 變得簡單",
    "de": "Typsichere APIs leicht gemacht",
    "fr": "Typesafe APIs simplifié",
    "uk": "Typesafe APIs Made Simple",
  },
  "Modern type-safe router for React": {
    ...
    "fr": "Routeur de type sécurisé moderne pour React",
  ...
  "Client-routed React SPA powered by Vite": {
    "es": "SPA React con routing en cliente y Vite",
    ...
    "de": "Vom Client weitergeleitetes React SPA mit Unterstützung von Vite",
    "fr": "SPA React acheminé par le client et alimenté par Vite",
  ...
  "React framework with hybrid rendering": {
    ...
    "uk": "React фреймворк із гібридним відтворенням",
  },
  ...
  "Full-stack Svelte framework for modern web apps": {
    ...
    "de": "Vollständiges Svelte-Framework für moderne Web-Apps",
    "fr": "Framework Svelte full-stack pour les applications Web modernes",
    "uk": "Повноцінний фреймворк Svelte для сучасних веб-програм",
  },
  "Fast JavaScript runtime & toolkit": {
    "es": "Runtime y toolkit JavaScript rápido",
    "zh": "高速 JavaScript 运行时和工具集",
    "ja": "高速 JavaScript ランタイムとツールキット",
    "ko": "빠른 JavaScript 런타임 및 툴킷",
    "zh-Hant": "快速 JavaScript 運行時和工具包",
  ...
  "Type-safe backend with built-in infrastructure": {
    ...
    "fr": "Backend de type sécurisé avec infrastructure intégrée",
    "uk": "Безпечний сервер із вбудованою інфраструктурою",
  },
  ...
  "NoSQL document database": {
    ...
    "fr": "Base de données documentaires NoSQL",
  ...
  "Type-safe SQL query builder": {
    ...
    "zh-Hant": "類型安全性 SQL 查詢產生器",
    "de": "Typsicherer SQL-Abfrage-Generator",
    "fr": "Générateur de requêtes SQL de type sécurisé",
  ...
  "Modern email API for developers": {
    ...
    "fr": "E-mail moderne API pour les développeurs",
    "uk": "Сучасна електронна пошта API для розробників",
  },
  "Lightweight state management with simple API": {
    "es": "Gestión de estado ligera con API simple",
    "zh": "轻量状态管理，API 简单",
    "ja": "シンプルな API による軽量の状態管理",
    "ko": "간단한 API을 사용한 경량 상태 관리",
    "zh-Hant": "使用簡單的 API 進行輕量級狀態管理",
    "de": "Leichtes Zustandsmanagement mit einfachem API",
    "fr": "Gestion d'état légère avec API simple",
    "uk": "Полегшене керування станом за допомогою простого API",
  },
  "Performant, flexible form validation library": {
    "es": "Librería de formularios rápida y flexible",
    "zh": "高性能、灵活的表单校验库",
...
const PRESET_DESCRIPTIONS: Record<string, LocalizedMap> = {
  "Next.js + Tailwind + shadcn/ui — no database or backend": {
    ...
    "de": "Next.js + Tailwind + shadcn/ui – keine Datenbank oder Backend",
    "fr": "Next.js + Tailwind + shadcn/ui — pas de base de données ni de backend",
    "uk": "Next.js + Tailwind + shadcn/ui — немає бази даних або серверної частини",
  },
  ...
  "Expo + Uniwind native app with no backend": {
    ...
    "zh-Hant": "Expo + Uniwind 無後端的本機應用程式",
    "de": "Expo + Uniwind native App ohne Backend",
    "fr": "Application native Expo + Uniwind sans backend",
    "uk": "Expo + Uniwind рідна програма без серверної частини",
  },
  "Expo with bare workflow — no backend": {
    "es": "Expo con bare workflow — sin backend",
    "zh": "Expo bare workflow — 无后端",
    "ja": "Expo (ワークフローなし) - バックエンドなし",
    "ko": "Expo(기본 워크플로 포함) — 백엔드 없음",
    "zh-Hant": "Expo 具有裸露工作流程 — 無後端",
    "de": "Expo mit nacktem Workflow – kein Backend",
    "fr": "Expo avec flux de travail simple – pas de backend",
    "uk": "Expo з простим робочим процесом — без серверної частини",
  },
};
