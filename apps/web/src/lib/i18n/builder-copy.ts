...
const SECTION_NAMES: Record<string, LocalizedMap> = {
  frontend: {
    "es": "Frontend",
    "zh": "前端",
    "ja": "フロントエンド",
  ...
  frontendLibraries: {
    "es": "Librerías de frontend",
    "zh": "前端库",
    "ja": "フロントエンドライブラリ",
    "ko": "프론트엔드 라이브러리",
    "zh-Hant": "前端函式庫",
    "de": "Frontend-Bibliotheken",
    "fr": "Bibliothèques frontend",
    "uk": "Фронтенд-бібліотеки",
  },
  backendApi: {
    "es": "Backend y API",
    "zh": "后端与 API",
  ...
  backendLibs: {
    "es": "Librerías de backend",
    "zh": "后端库",
    "ja": "バックエンドライブラリ",
    "ko": "백엔드 라이브러리",
    "zh-Hant": "後端函式庫",
    "de": "Backend-Bibliotheken",
    "fr": "Bibliothèques backend",
    "uk": "Бекенд-бібліотеки",
  },
  data: {
  ...
  authSecurity: {
    ...
    "uk": "Автентифікація та безпека",
  },
  product: {
    "es": "Funcionalidades de producto",
    "zh": "产品功能",
    "ja": "プロダクト機能",
    "ko": "제품 기능",
    "zh-Hant": "產品功能",
    "de": "Produktfunktionen",
    "fr": "Fonctionnalités produit",
    "uk": "Продуктові функції",
  },
  realtimeJobs: {
    "es": "Tiempo real y tareas",
    "zh": "实时与任务",
    "ja": "リアルタイムとジョブ",
    "ko": "실시간 및 작업",
    "zh-Hant": "即時與任務",
    "de": "Realtime & Jobs",
    "fr": "Temps réel et tâches",
    "uk": "Реальний час і задачі",
  },
  ai: {
    "es": "IA",
    "zh": "AI",
  ...
  observability: {
    ...
    "ko": "관측성 및 분석",
    "zh-Hant": "可觀測性與分析",
    "de": "Observability & Analytics",
    "fr": "Observabilité et analytique",
    "uk": "Спостережуваність та аналітика",
  },
  qualityTesting: {
    "es": "Calidad y pruebas",
    "zh": "质量与测试",
    "ja": "品質とテスト",
    "ko": "품질 및 테스트",
    "zh-Hant": "品質與測試",
    "de": "Qualität & Tests",
    "fr": "Qualité et tests",
    "uk": "Якість і тестування",
  },
  workspaceTooling: {
    "es": "Workspace y herramientas",
    "zh": "工作区与工具",
    "ja": "ワークスペースとツール",
    "ko": "워크스페이스 및 도구",
    "zh-Hant": "工作區與工具",
    "de": "Workspace & Tooling",
    "fr": "Espace de travail et outils",
    "uk": "Робочий простір та інструменти",
  },
  deployScaffold: {
    "es": "Despliegue y scaffold",
    "zh": "部署与脚手架",
    "ja": "デプロイとスキャフォールド",
    "ko": "배포 및 스캐폴드",
    "zh-Hant": "部署與鷹架",
    "de": "Deployment & Scaffold",
    "fr": "Déploiement et scaffold",
    "uk": "Розгортання та скафолд",
  },
  mobileFrameworks: {
    "es": "Frameworks móviles",
    "zh": "移动框架",
    "ja": "モバイルフレームワーク",
    "ko": "모바일 프레임워크",
    "zh-Hant": "行動框架",
    "de": "Mobile Frameworks",
    "fr": "Frameworks mobiles",
    "uk": "Мобільні фреймворки",
  },
  appExperience: {
    "es": "Experiencia de la app",
    "zh": "应用体验",
    "ja": "アプリ体験",
    "ko": "앱 경험",
    "zh-Hant": "應用體驗",
    "de": "App-Erlebnis",
    "fr": "Expérience applicative",
    "uk": "Досвід застосунку",
  },
  testingDelivery: {
    "es": "Pruebas y entrega",
    "zh": "测试与交付",
    "ja": "テストと配信",
    "ko": "테스트 및 딜리버리",
    "zh-Hant": "測試與交付",
    "de": "Tests & Auslieferung",
    "fr": "Tests et livraison",
    "uk": "Тестування та доставлення",
  },
  authPayments: {
    "es": "Autenticación y pagos",
    "zh": "认证与支付",
    "ja": "認証と決済",
    "ko": "인증 및 결제",
    "zh-Hant": "認證與支付",
    "de": "Auth & Zahlungen",
    "fr": "Authentification et paiements",
    "uk": "Автентифікація та платежі",
  },
  webApi: {
    "es": "Web y API",
    "zh": "Web 与 API",
  ...
  services: {
    "es": "Autenticación y servicios",
    "zh": "认证与服务",
    "ja": "認証とサービス",
    "ko": "인증 및 서비스",
    "zh-Hant": "認證與服務",
    "de": "Auth & Dienste",
    "fr": "Authentification et services",
    "uk": "Автентифікація та сервіси",
  },
  coreTooling: {
    "es": "Núcleo y herramientas",
    "zh": "核心与工具",
    "ja": "コアとツール",
    "ko": "코어 및 도구",
    "zh-Hant": "核心與工具",
  ...
  aiData: {
    ...
    "zh-Hant": "AI 與資料科學",
    "de": "KI & Data Science",
    "fr": "IA et science des données",
    "uk": "ШІ та наука про дані",
  },
  libraries: {
    "es": "Librerías y utilidades",
    "zh": "库与实用工具",
    "ja": "ライブラリとユーティリティ",
    "ko": "라이브러리 및 유틸리티",
    "zh-Hant": "函式庫與工具",
    "de": "Bibliotheken & Utilities",
    "fr": "Bibliothèques et utilitaires",
    "uk": "Бібліотеки та утиліти",
  },
  frameworkBuild: {
    "es": "Framework y build",
    "zh": "框架与构建",
    "ja": "フレームワークとビルド",
    "ko": "프레임워크 및 빌드",
    "zh-Hant": "框架與建置",
    "de": "Framework & Build",
    "fr": "Framework et build",
    "uk": "Фреймворк і збірка",
  },
};

export function getLocalizedSectionName(sectionKey: string, fallback: string): string {
  const locale = currentLocale();
  return SECTION_NAMES[sectionKey]?.[locale] ?? fallback;
}
