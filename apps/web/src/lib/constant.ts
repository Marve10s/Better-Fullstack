  ...
  pythonGraphql: [
    {
      ...
      description: "Code-first GraphQL library leveraging Python type hints, async support, seamless framework integration",
      icon: "https://cdn.simpleicons.org/graphql/E10098",
      color: "from-pink-500 to-rose-600",
      default: false,
    },
    {
      id: "none",
      name: "No GraphQL Library",
      description: "Skip Python GraphQL library selection",
      icon: "",
      color: "from-gray-400 to-gray-600",
      default: true,
    },
