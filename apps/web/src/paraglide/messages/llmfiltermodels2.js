...
const uk_llmfiltermodels2 = /** @type {(inputs: Llmfiltermodels2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Фільтрувати моделі`)
};
...
*/
const llmfiltermodels2 = /** @type {((inputs?: Llmfiltermodels2Inputs, options?: { locale?: "en" | "es" | "zh" | "ja" | "ko" | "zh-Hant" | "de" | "fr" | "uk" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Llmfiltermodels2Inputs, { locale?: "en" | "es" | "zh" | "ja" | "ko" | "zh-Hant" | "de" | "fr" | "uk" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_llmfiltermodels2(inputs)
	if (locale === "uk") return uk_llmfiltermodels2(inputs)
	return en_llmfiltermodels2(inputs)
});
