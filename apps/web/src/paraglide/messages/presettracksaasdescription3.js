...
const uk_presettracksaasdescription3 = /** @type {(inputs: Presettracksaasdescription3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Next.js з автентифікацією, реляційними даними, платежами, електронною поштою та формою програми, готовою до розгортання.`)
};
