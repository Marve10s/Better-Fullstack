...
const ko_comparetypesafeapis3 = /** @type {(inputs: Comparetypesafeapis3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`타입 안전 API(tRPC, oRPC, GraphQL)`)
};
...
const fr_comparetypesafeapis3 = /** @type {(inputs: Comparetypesafeapis3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`APIs à typage sûr (tRPC, oRPC, GraphQL)`)
};

const uk_comparetypesafeapis3 = /** @type {(inputs: Comparetypesafeapis3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Типобезпечні API (tRPC, oRPC, GraphQL)`)
};
