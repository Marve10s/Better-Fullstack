...
const uk_runctawriteup2 = /** @type {(inputs: Runctawriteup2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Читати розбір`)
};
...
*/
const runctawriteup2 = /** @type {((inputs?: Runctawriteup2Inputs, options?: { locale?: "en" | "es" | "zh" | "ja" | "ko" | "zh-Hant" | "de" | "fr" | "uk" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Runctawriteup2Inputs, { locale?: "en" | "es" | "zh" | "ja" | "ko" | "zh-Hant" | "de" | "fr" | "uk" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_runctawriteup2(inputs)
	if (locale === "uk") return uk_runctawriteup2(inputs)
	return en_runctawriteup2(inputs)
});
