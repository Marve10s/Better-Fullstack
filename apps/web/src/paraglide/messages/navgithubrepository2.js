...
const uk_navgithubrepository2 = /** @type {(inputs: Navgithubrepository2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Репозиторій GitHub`)
};
...
*/
const navgithubrepository2 = /** @type {((inputs?: Navgithubrepository2Inputs, options?: { locale?: "en" | "es" | "zh" | "ja" | "ko" | "zh-Hant" | "de" | "fr" | "uk" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Navgithubrepository2Inputs, { locale?: "en" | "es" | "zh" | "ja" | "ko" | "zh-Hant" | "de" | "fr" | "uk" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_navgithubrepository2(inputs)
	if (locale === "uk") return uk_navgithubrepository2(inputs)
	return en_navgithubrepository2(inputs)
});
