...
const ko_changelogrelease20260612highlightmulti3 = /** @type {(inputs: Changelogrelease20260612highlightmulti3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`ORM 종속성 및 인증 스키마가 누락된 다중 생태계 데이터베이스 패키지를 수정하고 unistyles 네이티브 템플릿의 Better Auth에 대한 누락된 expo-network 종속성을 추가했습니다.`)
};
...
const uk_changelogrelease20260612highlightmulti3 = /** @type {(inputs: Changelogrelease20260612highlightmulti3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Виправили multi-ecosystem database packages, де бракувало ORM-залежностей і auth-схеми, а також додали відсутню залежність expo-network для Better Auth у native-шаблоні unistyles.`)
};
...
const changelogrelease20260612highlightmulti3 = /** @type {((inputs?: Changelogrelease20260612highlightmulti3Inputs, options?: { locale?: "en" | "es" | "zh" | "ja" | "ko" | "zh-Hant" | "de" | "fr" | "uk" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Changelogrelease20260612highlightmulti3Inputs, { locale?: "en" | "es" | "zh" | "ja" | "ko" | "zh-Hant" | "de" | "fr" | "uk" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "uk") return uk_changelogrelease20260612highlightmulti3(inputs)
	return en_changelogrelease20260612highlightmulti3(inputs)
});
