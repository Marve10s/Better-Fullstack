...
const en_fixproofclaim1 = /** @type {(inputs: Fixproofclaim1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Real issues from private and public codebases, sealed. Hidden tests decide.`)
};

const es_fixproofclaim1 = /** @type {(inputs: Fixproofclaim1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Errores reales de bases de código privadas y públicas, sellados. Deciden las pruebas ocultas.`)
};

const zh_fixproofclaim1 = /** @type {(inputs: Fixproofclaim1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`来自私有和公开代码库的真实问题，全部封闭。由隐藏测试判定。`)
};

const ja_fixproofclaim1 = /** @type {(inputs: Fixproofclaim1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`非公開および公開コードベースの実際の不具合を封印。判定するのは非公開テストです。`)
};

const ko_fixproofclaim1 = /** @type {(inputs: Fixproofclaim1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`비공개 및 공개 코드베이스의 실제 이슈를 봉인했습니다. 판정은 비공개 테스트가 합니다.`)
};

const zh_hant1_fixproofclaim1 = /** @type {(inputs: Fixproofclaim1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`來自私有和公開程式碼庫的真實問題，全部封閉。由隱藏測試判定。`)
};

const de_fixproofclaim1 = /** @type {(inputs: Fixproofclaim1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Echte Fehler aus privaten und öffentlichen Codebasen, versiegelt. Verborgene Tests entscheiden.`)
};

const fr_fixproofclaim1 = /** @type {(inputs: Fixproofclaim1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Des bugs réels issus de bases de code privées et publiques, scellés. Ce sont les tests cachés qui tranchent.`)
};

const uk_fixproofclaim1 = /** @type {(inputs: Fixproofclaim1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Реальні помилки з приватних і публічних кодових баз, закриті. Вирішують приховані тести.`)
};

/**
* | output |
* | --- |
* | "Real issues from private and public codebases, sealed. Hidden tests decide." |
*
