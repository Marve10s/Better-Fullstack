...
const uk_shortstackseodescription3 = /** @type {(inputs: Shortstackseodescription3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Відкрийте коротке посилання конфігурації конструктора Better Fullstack.`)
};
