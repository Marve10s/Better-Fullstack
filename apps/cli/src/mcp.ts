...
const ECOSYSTEM_CATEGORIES: Record<string, string[]> = {
  typescript: [
    ...
    "logging", "backendUtils", "observability", "featureFlags", "analytics", "cms", "caching",
...
function buildProjectConfig(
  ...
  return {
    ...
    backendUtils: (input.backendUtils as ProjectConfig["backendUtils"]) ?? "none",
...
function buildCompatibilityInput(input: Record<string, unknown>): CompatibilityInput {
  ...
  return {
    ...
    backendUtils: (input.backendUtils as string) ?? "none",
...
export async function startMcpServer() {
  ...
  const planCreateSchema = {
    ...
    animation: AnimationSchema.optional().describe("Animation library"),
    logging: LoggingSchema.optional().describe("Logging library"),
    backendUtils: BackendUtilsSchema.optional().describe("Backend utilities"),
