...
export function buildCompatibilityInputFromConfig(
  ...
  return {
    ...
    dotnetFrontend: asString(config.dotnetFrontend),
    kotlinMobile: asString(config.kotlinMobile),
    kotlinMobileLibraries: asStringArray(config.kotlinMobileLibraries),
    swiftMobile: asString(config.swiftMobile),
    dartMobile: asString(config.dartMobile),
