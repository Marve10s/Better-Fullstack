...
export function buildBtsConfigForPersistence(
  ...
  return {
    ...
    ecommerce: persistedConfig.ecommerce,
    analytics: persistedConfig.analytics,
    webMcp: persistedConfig.webMcp ?? "none",
    ...
    botProtection: persistedConfig.botProtection,
...
export function serializeBtsConfig(
  ...
  const baseContent = {
    ...
    integrations: btsConfig.integrations,
    ecommerce: btsConfig.ecommerce,
    analytics: btsConfig.analytics,
    webMcp: btsConfig.webMcp,
    ...
    botProtection: btsConfig.botProtection,
    i18n: btsConfig.i18n,
