...
import { validateGoExpansionConstraints } from "@/config/config-validation";
import { runWithContext } from "@/presentation/context";
import { extractEnumValues } from "@test/support/test-utils";
import {
...
describe("Go Language Support", () => {
  describe("Schema Definitions", () => {
    it("should include Go alongside the other ecosystem schema values", () => {
