...
describe("Template Snapshots - Python Ecosystem", () => {
  const PYTHON_CONFIGS = [
    ...
    {
      name: "aiohttp-python-expansion",
      config: {
        ecosystem: "python" as const,
        database: "mongodb" as const,
        pythonWebFramework: "aiohttp" as const,
        pythonOrm: "pymongo" as const,
        pythonValidation: "none" as const,
        pythonAi: ["pytorch", "transformers", "scikit-learn", "tensorflow", "mcp"] as const,
        pythonAuth: "pyjwt" as const,
        pythonTaskQueue: "none" as const,
        pythonGraphql: "none" as const,
        pythonQuality: "ruff" as const,
        pythonTesting: ["pytest-cov"] as const,
        pythonObservability: "prometheus-client" as const,
        pythonCloudSdk: "boto3" as const,
        pythonHttpClient: "requests" as const,
        pythonData: ["numpy", "pandas", "scipy"] as const,
        pythonMedia: "pillow" as const,
        pythonServer: "gunicorn" as const,
        pythonPackageManager: "poetry" as const,
        pythonMessageQueue: "confluent-kafka" as const,
      },
    },
    {
      name: "streamlit-data",
