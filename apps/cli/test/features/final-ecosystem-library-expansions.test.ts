...
import { resolveDotnetLibrariesPrompt } from "@/prompts/ecosystems/dotnet-ecosystem";
import { resolveMobileLibrariesPrompt } from "@/prompts/architecture/mobile";
import { DOTNET_LIBRARIES_VALUES, MOBILE_LIBRARIES_VALUES } from "@/types";
