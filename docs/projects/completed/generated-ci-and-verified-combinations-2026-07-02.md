...
- [x] `scripts/release/published-package-smoke.ts` records Bun, npm, and pnpm package-manager scaffold evidence to `testing/.published-package/summary.json`.
...
- `bun test apps/cli/test/generation/virtual-generator-regressions.test.ts`
