...
Phase 1 hardening work moved into `docs/projects/completed/ci-security-foundation-2026-04-04.md` and
`docs/projects/completed/phase-1-quality-hardening-2026-04-04.md`.
