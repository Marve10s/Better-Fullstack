...
- `packages/types/src/config/schemas.ts` accepts both search selections.
- `packages/template-generator/src/processors/dependencies/search-deps.ts` adds their clients.
