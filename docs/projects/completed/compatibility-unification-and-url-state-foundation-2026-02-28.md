...
- Added shared compatibility engine in `packages/types/src/stack/compatibility.ts` and exported from `packages/types/src/index.ts`.
...
- `cd apps/cli && bun test test/recommendations/cli-builder-sync.test.ts` -> PASS
