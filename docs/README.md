...
6. `docs/reference/` for time-bound research and technical inventories.
7. `docs/projects/completed/` for historical implementation context.
...
- Before moving a completed project, extract any still-authoritative rule into a guideline.
