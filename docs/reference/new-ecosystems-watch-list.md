# New Language Ecosystem Watch List
...
This is research/reference, not accepted backlog. Promote a candidate into `docs/projects/backlog/`
only after demand and ecosystem maturity justify implementation.
