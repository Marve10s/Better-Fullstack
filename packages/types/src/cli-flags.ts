...
export const CLI_FLAG_GROUP_DEFINITIONS: readonly CliFlagGroupDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      { flag: "elixir-i18n", summary: "Elixir internationalization.", source: { kind: "category", category: "elixirI18n" }, configKey: "elixirI18n" },
      { flag: "elixir-http-server", summary: "Elixir HTTP server.", source: { kind: "category", category: "elixirHttpServer" }, configKey: "elixirHttpServer" },
      { flag: "elixir-application-framework", summary: "Elixir application framework.", source: { kind: "category", category: "elixirApplicationFramework" }, configKey: "elixirApplicationFramework" },
      { flag: "elixir-documentation", summary: "Elixir documentation.", source: { kind: "category", category: "elixirDocumentation" }, configKey: "elixirDocumentation" },
      { flag: "elixir-clustering", summary: "Elixir clustering.", source: { kind: "category", category: "elixirClustering" }, configKey: "elixirClustering" },
