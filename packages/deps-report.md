...
|---------|---------|--------|-----------|--------|
| expo-linking | ^56.0.14 | ^57.0.7 | - | map |
| expo-constants | ^56.0.18 | ^57.0.13 | - | map |
...
| oxfmt | ^0.56.0 | ^0.64.0 | - | map |
| @netlify/functions | ^5.3.0 | ^6.0.0 | - | map |
| @vercel/sandbox | ^2.9.2 | ^3.1.0 | - | map |
| vercel | ^54.18.2 | ^59.4.0 | - | map |
| @openai/agents | ^0.12.0 | ^0.17.0 | - | map |
| openai | ^6.49.0 | ^7.5.0 | - | map |
| @anthropic-ai/sdk | ^0.110.0 | ^0.120.0 | - | map |
...
| @tanstack/vue-db | ^0.0.123 | ^0.1.4 | - | map |
| @tanstack/svelte-db | ^0.1.94 | ^0.3.2 | - | map |
| @tanstack/pacer | ^0.21.1 | ^0.22.0 | - | map |
| @tanstack/react-pacer | ^0.22.1 | ^0.23.0 | - | map |
| @tanstack/solid-pacer | ^0.21.1 | ^0.22.0 | - | map |
| @tanstack/ai | ^0.38.0 | ^0.48.0 | - | map |
| @tanstack/ai-react | ^0.16.4 | ^0.21.3 | - | map |
| @tanstack/ai-solid | ^0.14.3 | ^0.18.3 | - | map |
| @cloudflare/workers-types | ^4.20260629.1 | ^5.20260822.1 | cloudflare | map |
...
| lottie-react | ^2.4.1 | ^3.1.0 | - | map |
| react-native-purchases | ^9.10.5 | ^10.7.2 | - | map |
| @commet/node | ^7.10.0 | ^9.2.0 | - | map |
| dd-trace | ^5.110.0 | ^6.12.0 | - | map |
| @axiomhq/js | ^1.8.0 | ^2.0.0 | - | map |
| @sanity/client | ^7.26.2 | ^8.2.0 | - | map |
| @directus/sdk | ^22.0.0 | ^25.0.0 | - | map |
| @keystatic/core | ^0.5.51 | ^0.6.8 | - | map |
| intlayer | ^8.12.4 | ^9.3.3 | - | map |
| react-intlayer | ^8.12.4 | ^9.3.3 | - | map |
...
| expo-splash-screen | ^56.0.10 | ^57.0.7 | - | template |
