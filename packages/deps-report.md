...
| @effect/platform-bun | ^0.90.0 | ^0.91.0 | effect | map |
| @effect/platform-browser | ^0.76.0 | ^0.77.0 | effect | map |
| @effect/sql | ^0.51.1 | ^0.52.0 | effect | map |
...
| @effect/cli | ^0.75.2 | ^0.76.0 | effect | map |
| @effect/vitest | ^0.29.0 | ^0.30.0 | effect | map |
| @effect/opentelemetry | ^0.63.0 | ^0.64.0 | effect | map |
| @effect/rpc | ^0.75.1 | ^0.76.0 | effect | map |
| @effect/cluster | ^0.59.0 | ^0.60.0 | effect | map |
| @effect/workflow | ^0.18.2 | ^0.19.0 | effect | map |
