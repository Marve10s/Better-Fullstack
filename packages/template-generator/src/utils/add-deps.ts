...
export const dependencyVersionMap = {
  ...
  "@prisma/adapter-planetscale": "^7.5.0",
  ...
  "@tanstack/router-cli": "^1.166.11",

  "@tanstack/solid-query": "^5.90.26",
  "@tanstack/solid-query-devtools": "^5.91.3",
  "@tanstack/solid-router-devtools": "^1.166.9",
