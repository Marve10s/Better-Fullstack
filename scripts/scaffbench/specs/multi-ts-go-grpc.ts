...
export const MultiTsGoGrpcSpec: BenchmarkSpec = {
    ...
    strictMarkers: [
      ...
      { id: "orm:sqlc", files: ["sqlc.*"] },
      { id: "db:postgres", textAny: ["lib/pq", "jackc/pgx", "postgres"] },
      ...
      { id: "forbidden:ent", forbiddenText: ["entgo.io/ent"] },
      { id: "forbidden:viper", forbiddenText: ["github.com/spf13/viper"] },
      {
        id: "forbidden:redis",
        forbiddenText: ["github.com/redis/go-redis", "github.com/go-redis/redis"],
      },
      { id: "forbidden:zap", forbiddenText: ["go.uber.org/zap"] },
    ],
