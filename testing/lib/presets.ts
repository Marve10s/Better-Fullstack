...
const SMOKE_TEST_PRESETS: Record<string, PresetDef> = {
  ...
  "python-library-expansion-primary": {
    ecosystem: "python",
    overrides: {
      pythonWebFramework: "fastapi",
      pythonOrm: "sqlalchemy",
  ...
  "dotnet-library-expansion-primary": {
    ecosystem: "dotnet",
    overrides: {
      database: "none",
      dotnetWebFramework: "aspnet-minimal",
  ...
  "react-native-library-expansion-primary": {
